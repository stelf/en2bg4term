...
data mining | извличане на закономерности (от данни) | _разбира се приветстваме употребата на "копане на данни" или дори още по-скандалното „разкопаване за зависимости“ :D_
