...
Често се посочва аргумента, че е по-лесно говоренето с чуждици. За сметка на това използването на правилните термини на български подсказва за едно осъзнато изработване на изреченията, познаване на материята и кой феномен към какво се отнася. Макар и трудно, това е и един вид тренировка на мисълта. 
