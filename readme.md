...
Разбира се, има думи, чуждици, които вече са утвърдени в книжовния език и тях няма да ги закачаме в нелепи опити за _по-точен превод_. Например: index/индекс, program/програма, system/система, системен и т.н.
