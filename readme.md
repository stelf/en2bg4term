...
(an) outlier | (необичайно) отклонение, аномалия (ч), отличителен/извънреден случай | _„частен случай“ също може да се [използва](http://www.ezikov.com/translate/outlier). да не се бърка със spike, което е пик/скок - временно явление, докато outlier е по-скоро необичайно наблюдение, което се отличава значително от другите такива_
