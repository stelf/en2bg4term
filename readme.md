...
descent | спускане, намаляване | _и често се среща в словосъчетание [gradient descent](https://en.wikipedia.org/wiki/Gradient_descent). Нарастване/намаляване акцентира върху промяната на функцията (стойността расте/намалява). Изкачване/спускане акцентира върху движението в пространството (качваме се/слизаме по повърхността)._
