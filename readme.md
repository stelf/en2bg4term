...
batch | партида(ч), порция (ч), пакет (ч), пачка (ч) | _макар че пакет е чуждица, а партида идва от латинското [pars](https://bg.wiktionary.org/wiki/%D0%BF%D0%B0%D1%80%D1%82%D0%B8%D0%B4%D0%B0). вероятно според изложението може да се ползват и 'купчина', а смислово най-правилният превод би бил '[вързоп](https://en.wiktionary.org/wiki/%D0%BF%D0%B0%D1%87%D0%BA%D0%B0)'_
