...
bundle | вързоп, пакет (което също е чуждица, но вече възприета в книжовния български)
bug | недостатък, дефект (което също е чуждица, но вече възприета в книжовния български)
button | копче | _макар че и 'бутон' е възприето като чуждица_
