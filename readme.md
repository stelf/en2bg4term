...
alias | [прякор](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D1%8F%D0%BA%D0%BE%D1%80/), псевдоним | псевдоним също е [чуждица](https://en.wikipedia.org/wiki/Pseudonym) От гр. ψευδόνυμος ‘с лъжливо име’.
...
(to) assess | оценявам
(an) asset | собственост, [придобивка](http://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D0%B8%D0%B4%D0%BE%D0%B1%D0%B8%D0%B2%D0%BA%D0%B0/)
...
available | наличен
avatar | [лик](http://ibl.bas.bg/rbe/lang/bg/%D0%BB%D0%B8%D0%BA/), [облик](http://ibl.bas.bg/rbe/lang/bg/%D0%BE%D0%B1%D0%BB%D0%B8%D0%BA/)
...
backdoor | задна врата, таен вход | _понятие от областта на комп. сигурност. става дума за поставяне на софтуер, който предоставя скрит достъп до дадено приложене/система/сървър. вторият превод е по-скоро смислов, но в някои от преводите на понятието от [wikipedia](https://en.wikipedia.org/wiki/Backdoor_(computing)) се ползвай той (в [Словенски приемрно](https://sk.wikipedia.org/wiki/Met%C3%B3da_tajn%C3%BDch_vchodov), един славянски език). На други места се водят от руснаците, които верни на своята любов към чуждиците са записали - Бэкдор_ 
background | фонов | _заб. [фон](https://ibl.bas.bg/rbe/lang/bg/%D1%84%D0%BE%D0%BD/) произлиза от френското fond «дъно», и лат. fundus. справка [wiktionary](https://ru.wiktionary.org/wiki/%D1%84%D0%BE%D0%BD#%D0%AD%D1%82%D0%B8%D0%BC%D0%BE%D0%BB%D0%BE%D0%B3%D0%B8%D1%8F)_
...
bandwidth | честотна лента, ширина, пропускателна способност | буквално означава _ширина на лентата_. незнайно защо се ползва _дебит_ в доста преводи, но всъщност то идва от латинското [dēbitum](https://en.wiktionary.org/wiki/debit#Etymology_1) и е по-скоро свързано с дълг. [лента](http://ibl.bas.bg/rbe/lang/bg/%D0%BB%D0%B5%D0%BD%D1%82%D0%B0/) също е от латински според БАН.
...
bookmark | показалец, отметка (рус.)
...
public key | явен ключ, обществен ключ, оповестим ключ
publish | издавам, оповествявам, обнародвам | _заб: „публикувам“ е чуждица, макар БАН да твърди и за [обнародвам](http://ibl.bas.bg/rbe/lang/bg/%D0%BE%D0%B1%D0%BD%D0%B0%D1%80%D0%BE%D0%B4%D0%B2%D0%B0%D0%BC/), че е от руски_
(to) pull | издърпвам
...
subroutine | подпрограма | _...което е чуждица, защото програма е внос. но изумително думата е вписана в [книжовния от БАН](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D0%BE%D0%B4%D0%BF%D1%80%D0%BE%D0%B3%D1%80%D0%B0%D0%BC%D0%B0/)_
