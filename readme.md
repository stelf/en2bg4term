...
Настоящето хранилище следва да организира на едно място речник с кратък и удобен превод на често ползвани в писма и разговори технологични понятия (STEM). Където е възможно, са допълнени препратки към история на произхода (етимология) или други разяснения, едва ли не почти научни, но проектът е по-скоро любителски по същество.

Подходът включва предоставяне на преводите за напълно свободно и открито ползване. И тук-таме стремеж за обяснение под формата на примери за употреба към преводите.
...
_Важно: в зависимост от убежденията си, вие можете да се съгласите напълно или да оспорите почти всяка част от казаното като цяло "за думите" тук, защото дори само пишейки този увод се затруднявам да намеря напълно 'девствен' словоред без чуждици.  Безумно е да си представим, че в 21 век ще се разберем с някой на улицата ицяло на староцърковнославянски или изпобщо с подобен словореда. Ние живеем в нашето време и българският в този период (на живот на речника) е вече продукт, малко или много, от смесването с английския, дори като словоред. За това, от определена по-цинична гледна точка, бихме могли най-лесно да обобщим целия смисъл от съществуването на настоящия речник като "леко превзет",... но можем и да го приемем като опит, от който все пак може и да има някаква полза._
...
_[Иван Богоров](https://bg.wikipedia.org/wiki/%D0%98%D0%B2%D0%B0%D0%BD_%D0%91%D0%BE%D0%B3%D0%BE%D1%80%D0%BE%D0%B2)..., за него днес мнозина биха казали, че е бил още по-краен – създал и въвел нови български думи с ясно значение като „часовник“ и „вестник“. Може би ще се изненадате, че той не е бягал нито от английски, нито от френски, който вече е бил дал сериозно отражение на българския. Опитвал се е да избегне напора на панрусизма и влиянието му върху българския език и самосъзнание._
...
about | относно | _също така в смисъла на "за някого", но накратко може да значи и "относно себе си"_
(an) abut | подпора, устои, опора
(to) abut | опирам
...
(to) acquire | добивам, получавам | _"acquire data from sensors or external APIs" - добивам първоначално. вж. още retrieve_
...
actuator | разпределително у-во | _вярваш или не, такова е (вече) [установеното понятие на български](https://bg.wikipedia.org/wiki/%D0%98%D0%B7%D0%BF%D1%8A%D0%BB%D0%BD%D0%B8%D1%82%D0%B5%D0%BB%D0%BD%D0%BE_%D1%83%D1%81%D1%82%D1%80%D0%BE%D0%B9%D1%81%D1%82%D0%B2%D0%BE)_
...
[annulus](https://en.wikipedia.org/wiki/Annulus_(mathematics)) | пръстен
[aperture](https://en.wikipedia.org/wiki/Aperture) | отвор, пролука, бленда (ч) | 
...
arid | сух | _в по-научния и климатичен смисъл спрямо 'dry', което също означава сух, но е с германски корени, докато arid е от латински
aridity | сухота | _което неясно защо някой в бг википедията е превел като 'сух климат'_
...
ascent | изкачване, нарастване | _Нарастване/намаляване акцентира върху промяната на функцията (стойността расте/намалява). Изкачване/спускане акцентира върху движението в пространството (качваме се/слизаме по повърхността)._
...
attention mechanism | механизъм на внимание, насочено внимание | _ключова част в постановката на трансформърите_
...
attrition | умора, износване | _най-вече за сравнение с горното, което означава съвсем друго. може да чуете термина war of attrition, който очевадно не е от областта на технологиите в прекия смисъл_
audio | звук, звуков
...
[axis](https://en.wikipedia.org/wiki/Coordinate_system#Coordinate_axis) | ос
axial | осев
...
(a) border | ръб, ограда, граница | _ръб е от цслав. рѫбъ_
border, borderline | граничен
...
bound | скрепен, привързан (към), вързан (за), прихванат (за), свързан, ограничен
boundary | граничен
(a) boundary | граница, ограничение
bracket | скоба
branching | разклоняване | _и от там conditional branching - условно разклонение_
...
brevity | яснота, краткост, стегнатост | _нищо общо с bravery_
briefly | на кратко |
brightness | яркост
...
checkpoint | контролна точка, междинно запазване
...
[coarse](https://en.wikipedia.org/wiki/Coarse_structure) | груб
...
coherence | съгласуваност, съгласие, кохерентност(ч) | _Кохерентността е, по принцип, състояние или ситуация, при която всички части или идеи се съчетават добре, така че да образуват едно цяло. За това казвае, че частите са съгласувани, има съгласуваност_
...
compilation | събиране, струпване, [окомплектоване (ч)](http://ibl.bas.bg/rbe/lang/bg/%D0%BE%D0%BA%D0%BE%D0%BC%D0%BF%D0%BB%D0%B5%D0%BA%D1%82%D0%BE%D0%B2%D0%B0%D0%BD%D0%B5/)  | _в смисъл на събиране на едно място на сходни по свойства обекти, с уговорката, че комплект е от латинското complectī._
...
[continuity] | непрекъснатост, последователност, приемственост | _най-често при STEM в смисъла на непрекъсната ф-я_
(a) contract | договор
...
(to) converge | _, свеждам към, (се) сближавам, стичам към, отивам към/в (жарг) 
...
convolutional | свиващ, навиващ | _в контекста на CNN - convolution е свиване/навиване_
...
cross-validation | взаимна проверка, кръстосано потвърждаване
...
damage | повреда
dangling | висящ | _най-често ще срещнете [Dangling Pointer](https://en.wikipedia.org/wiki/Dangling_pointer), което е букв. висящ указател (вкл. на руски така му казват според речника)_
...
designation | предназначение, обозначение
...
descent | спускане, намаляване; произход | _и често се среща в словосъчетание [gradient descent](https://en.wikipedia.org/wiki/Gradient_descent). Нарастване/намаляване акцентира върху промяната на функцията (стойността расте/намалява). Изкачване/спускане акцентира върху движението в пространството (качваме се/слизаме по повърхността). смисълът 'произход' е, когато descent е синоним на provenance и origin._
...
detection | откриване, разпознаване, засичане
...
[(knowledge) distillation](https://en.wikipedia.org/wiki/Knowledge_distillation) | отсяване на знание | _отсяване на важното бихме казали на български, но сигурно става и отцеждане на знанието_
(a) divider | разделител
(to) document | описвам, записвам
...
(to) fan out | да разпръсна, разпределя, размятам (ж) | _това словосъчетание почна да се появява в последно време, може би жаргон наложен от ГЕМ-овете, а може би отпреди. буквално става дума за това да се "разпредели" някаква работа м/у сървъри_
...
(to) fetch | дръпвам, изтеглям, вземам, извличам, добивам, издърпвам, измъквам
...
fungible | заменим, заместим, изменим | _виж [fungibility](https://en.wikipedia.org/wiki/Fungibility) и да, non-fungible token (NFT) е буквално такъв (жетон/знак/монета/), който не може да се заменя_
...
gradual | постепенен
gradient descent | спускане по градиента | _и преди някой да възрази срещу градиент, нека да обърнем внимание, че горенът не е gradus(лат) = "стъпка", а е gradiens (лат) - "вървящ, движещ се". и както можем да се уверим градиент е установено понятие, така както вектор, тензор, матрица и като цяло не би се повлияло от каквито и да било опити за превод_
grid | решетка, мрежа
...
--- | --- | ---
(a) handle | ръчка
(to) handle | боравя (с), поемам, обработвам
handler | обработваща функция(ч)
hallucination | [привиждане](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D0%B8%D0%B2%D0%B8%D0%B6%D0%B4%D0%B0%D0%BD%D0%B5/), мираж(ч), измислица | _когато моделът генерира невярна информация_
...
hoist | подемник, повдигач, лебедка | _и от там в JS е останало понятието hoisting, което обозначава особеноста на ```var``` променливите, които се смятат за определени в началото на функцията, независимо от това в коя част на тялото на функцията се появява реда с ```var``` и в този смисъл и те.
...
immersive | поглъщащ, потапящ, завладяващ | 
...
inclination | ъгъл на наклона | _което при f(x) = a*x+b е точно tan(α) = a. виж slope и intercept също_
include | включвам
...
(an) input | вход, въвеждане | _за входни данни_
(to) input | въвеждам | _като глагол_
inset | вложен, врязан, вписан, вкаран (вътре)
(to) inspect | преглеждам, проверявам, изследвам
...
interleaving | преплитане | _и изненадващо има поне няколко STEM понятия, които са в [някакъв смисъл преплитане ](https://en.wikipedia.org/wiki/Interleaving) на различни неща_
...
[intermittent](https://en.wikipedia.org/wiki/Intermittency) | прекъсващ, на пресекулки, непостоянен, преходен | _на украински това непостоянство е переміжність, което се превежда като променливост/преходност_ и понякога се среща и в смисъла на "преходно състояние"_
...
EN  | BG  | Забележка
--- | --- | ---
to jitter | треперя, трептя | _и често в смисъл на нещо, което спрямо друго нещо мърда "напред-назад", т.е. трепери_
...
(to) latch | захващам
(to) latch onto | захващам се (за), закачам се (за), прикрепям се (към) | _напр. точки, които са шум, се прикрепят/прихващат към най-близките клъстери/струпвания_
latent space | скрито пространство | _в #105 върви приказка защо е така избран избора. иначе става дума за [това понятие](https://en.wikipedia.org/wiki/Latent_space). latens на латински значи скрит_
latitude | ширина | _най-вече в ГИС системи_
...
latency | закъснение | _интересно е, че терминологията за мрежово закъснение е от 50-те на 20 век, а самата дума има корен [latent](https://www.etymonline.com/search?q=latency), което значи скрит_
...
magnitude | [величина](https://ibl.bas.bg/rbe/lang/bg/%D0%B2%D0%B5%D0%BB%D0%B8%D1%87%D0%B8%D0%BD%D0%B0/), степен, големина
...
memorization | запомняне, зазубряне | _обикновено обобщено за всякакъв вид кеширане на временно изчислени междинни стойности, така че да не ги смятаме пак в рамките на дадено изпълнение_
(a) merge | сливане
(to) merge | сливам
...
[offset](https://en.wikipedia.org/wiki/Offset_(computer_science)) | отместване, разместване, отклонение | _може да се срещне и в смисъла на отстояние_
...
overfitting | прекомерно напасване, пренатягане
...
parity | подобие, равенство, съответствие, аналогия, еднаквост
[parsimonious](https://en.wikipedia.org/wiki/Occam%27s_razor) | прост, (пестелив?) | _в смисъла на изискващ по-малко отправни точки или допускания, за постигане на дадено заключение_
...
(to) perturb | смущавам, безпокоя 
(a) perturbation | смущение | _в сигнала, изображението. може да го срещнете в [този смисъл](https://en.wikipedia.org/wiki/Perturbation_theory)_
...
(a) picture | картина(ч), изображение | _макар че, изображение е синоним, тъй като е букв. превод на image_
(a) pin | карфица, топлийка, габър
pinned | закован, [забоден](https://ibl.bas.bg/rbe/lang/bg/%D0%B7%D0%B0%D0%B1%D0%BE%D0%B4%D0%B5%D0%BD/), ковнат (ж), боднат (ж)
(a) pitch | наклон, височина на честотата | _макак и двете? наклон е, когато става дума за (pitch, yaw, roll). иначе може да е "височина на честотата" на тона в смисъла на това дали е басов или пищящ даден тон. 
...
pipeline | поточна линия(ч), тръбопровод, конвейер (ч) | _тъй като pipe (тръбата) носи потоци, а в pipeline няколко процеса „помпят“ данни един през друг_
...
plane | равнина | _и от там "tangent plane" = "допирателна равнина"_
...
probationary | изпитателен, опитен | _съществителното probation често означава изпитателен срок (като duration се пропуска)_
...
progenitor | прародител, предшественик
...
prong | зъб, зъбец | _синоним с [tine](https://en.wikipedia.org/wiki/Tine_(structural)) и tooth в смисъла на зъб като "успоредни или разклонени шипове, които са част от инструмент или естествен обект" (в букв превод от wikipedia). но, да кажем "Three-Pronged Solution", се превежда като тристранно решение_
...
radiance field | лъчево (лъчисто) поле | _Сърбите казват поле на осветеност, на английски понятието е [Neural Radiance Field](https://en.wikipedia.org/wiki/Neural_radiance_field) (NeRF)_
...
(a) ramp | [наклонена равнина](https://en.wikipedia.org/wiki/Inclined_plane), нарастване ([монотонно](https://en.wikipedia.org/wiki/Ramp_function))
random | случаен, произволен | _напр. слуачйна величина - random value_
ranking | класиране (ч), място в подредбата, подредба | _вкл. в смисъла на състезание или последователност на елементите след подреждане. например след подредба по даден критерии (order by), местата, които ще заемат резултатите са тяхното класиране (по подобие от състезанията)_
range | обхват, обсег, диапазон (ч)
...
regularization | [уравняване](https://ibl.bas.bg/rbe/lang/bg/%D1%83%D1%80%D0%B0%D0%B2%D0%BD%D1%8F%D0%B2%D0%B0%D0%BC/), изглаждане
...
(а) residual | несъответствие, остатък | _в смисъла на разминаването м/у [очакваната и получената](https://en.wikipedia.org/wiki/Residual_(numerical_analysis)) стойност._
residual | остатъчен
residue | остатък, отпадък, излишък
(a) retention | пазене, удържане | _и всичко друго, което е в смисъла на "временно пазене на нещо, за известно време". обичайно показва колко време се пазят някакви данни преди да се тръкнат._
...
(to) rerank | пренареждам, [прекласирам](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D0%B5%D0%BA%D0%BB%D0%B0%D1%81%D0%B8%D1%80%D0%B0%D0%BC/)
...
[ridge](https://en.wikipedia.org/wiki/Ridge) | хребет | _във връзка с [ridge detection](https://en.wikipedia.org/wiki/Ridge_detection) - откриване на хребети (на укр. казват виявляння хребтів)_
rim | обръч | _на жаргон му викат джанта (май от фр. jante), на македонски казват 'бандаж', което сигурно идва bondage. българското вероятно е от "обгръщам с ръка", в старобългрски има [обрѫт](https://histdict.uni-sofia.bg/oldbgdict/oldbg_show/d_05639/) - свързвам в свещен съюз._
rivet | [нит](https://ibl.bas.bg/rbe/lang/bg/%D0%BD%D0%B8%D1%82/) (ч) | _според БАН думата 'нит' е от немски Niet._
robustness | здравина, издръжливост, издържливост
...
(to) roll | въртя, търкалям
(a) roll | завъртане | _в смисъла на отклонение при [въртене по осите](https://en.wikipedia.org/wiki/Aircraft_principal_axes). 
[roundness](https://en.wikipedia.org/wiki/Robustness) | [заобленост](https://ibl.bas.bg/dictionary_portal/lang/bg/заобленост#rbeSearch)
...
EN  | BG  | Забележка
--- | --- | ---
[saddle point](https://uk.wikipedia.org/wiki/%D0%A1%D1%96%D0%B4%D0%BB%D0%BE%D0%B2%D0%B0_%D1%82%D0%BE%D1%87%D0%BA%D0%B0) | седлова точка | _на което украинците казват Сідлова точка, т.е. не е просто за езда или селско-стопанство запазено :D_
...
sampling | [пробване](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D0%BE%D0%B1%D0%B2%D0%B0%D0%BC/), вземане на проби | _избор на подмножество от данни_
...
shortcut | [препратка](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D0%B5%D0%BF%D1%80%D0%B0%D1%82%D0%BA%D0%B0/) | _и link и reference може да преведем така при други условия. интересно е, е французите (отново) си имат собствена дума за това - raccourci и в общия случай не ползват английската_
...
spatial | пространствен | _вж. space_
...
stakeholder | заинтересовано лице | _напр. организация спонсор, клиент (краен или ключов). stake е залог, т.е. тези _
stale | застоял, остарял, отлежал, изтъркан, залежал
...
(a) [stride](https://en.wikipedia.org/wiki/Stride_of_an_array) | стъпка, крачка, нарастване | _където нарастване е синонимът - increment_
(to) stride | да крача с широки крачки | _в смисъла да пропускам N от K при прегледа им (къдео N < K)._
strip, stripe | ивица
string | низ | _най-често се използва за обозначаване на знаков низ_
(to) stutter | заеквам, трептя | _често ползвано за описание на [зрителни артефакти](https://en.wikipedia.org/wiki/Screen_tearing) по видео и аудио потоци като например - срязан на две кадър, повтарящи се, зациклили кратки фрагменти и други видове нарушаване на сигнала_
...
tail | опашка
tangent | допирателна (геом), допиращ/а се (до) | _[допирателна](https://en.wikipedia.org/wiki/Tangent) крива/права/равнина/пространство. в смисъла на тригонометричната функция се ползва тангенс и се записва tan(α) или tg(α)_
...
[tension](https://en.wikipedia.org/wiki/Tension_(physics)) | опън, напън, напрежение, натягане
...
(a) tile, tiles | плочка/плочки, [мозайка (ч)](https://ibl.bas.bg/rbe/lang/bg/%D0%BC%D0%BE%D0%B7%D0%B0%D0%B9%D0%BA%D0%B0/), мозайки (ч) | _често срещано в картния (картовия) софтуер. например основен формат за пренос на векторни картни данни е map vector tile, който превеждаме като векторна мозайка. самата дума мозайка се оказва с произход от италиянски, но все пак книжовна според БАН. mosaïque е от френски, което е от италиански mosaico, което е от латински musivum - посветено на Музите (произведение)_ 
...
translucent | прозиращ, полупрозрачен | _[е тук обясняват](https://en.wikipedia.org/wiki/Transparency_and_translucency) защо translucent не е transparent_
...
transparent | прозрачен | _вж. и translucent_
...
[turnkey](https://en.wikipedia.org/wiki/Turnkey) | "до ключ"
...
### U
 ...
 EN | BG | Забележка |
---|---|---|
(to) unfold | разкривам, разгъвам, разгръщам | _даден тук като първи превод е разкривам, защото "something unfolds before us" буквално се превежда - нещо се разкрива пред нас, макар че fold/unfold често да се превеждат и като сгъвам/разгъвам_
...
unwieldy | тромав, неуправляем, труден за управление
...
validation set | [проверочен](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D0%BE%D0%B2%D0%B5%D1%80%D0%BE%D1%87%D0%B5%D0%BD/)(ч) набор, потвърждаващи данни
...
EN  | BG  | Забележка
--- | --- | ---
[wafer](https://en.wikipedia.org/wiki/Wafer_(electronics)) | [подложка](https://bg.wikipedia.org/wiki/%D0%9F%D0%BE%D0%B4%D0%BB%D0%BE%D0%B6%D0%BA%D0%B0_(%D0%B5%D0%BB%D0%B5%D0%BA%D1%82%D1%80%D0%BE%D0%BD%D0%B8%D0%BA%D0%B0)), плочка, вафла | _или с други думи - основата, на която се израстват, чрез нещо наречено епитаксия, кристалите, които после наричаме микропроцесори. установеното понятие на български е подложка, но буквалният превод е вафла. вж. chip_
...
to wind | вия, въртя, превъртам, навивам
(a) [winding](https://en.wikipedia.org/wiki/Electromagnetic_coil) | намотка
...
EN  | BG  | Забележка
--- | --- | ---
yaw | отклонение | _когато говорим за отклонение от трите оси в тримерно пространство се ползват pitch, yaw, roll. примерно във [въздухоплаването](https://en.wikipedia.org/wiki/Aircraft_principal_axes).
