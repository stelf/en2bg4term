...
deprecated | остарял, отпаднал | _много често за програмни интерфейси, които не е препоръчително да се ползват вбъдеще_
...
lateral | страничен | _и свързаните с понятието [lateral join](https://www.postgresql.org/docs/current/queries-table-expressions.html#QUERIES-LATERAL) и equilateral - равнобедрен_
