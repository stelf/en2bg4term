...
inclination | ъгъл на наклона, ъглов коефициент(ч) | _което при f(x) = a*x+b е точно tan(α) = a. виж slope и intercept също_
include | включвам
...
slope | наклон | _и обикновено на английски f(x) = a*x+b се обяснява със slope и y-intercept, където параметъра `a` е наклонът на правата, а y-intercept, което е отклонението по ординатата (или свободен член (или константа)), обозначава параметъра `b`._
...
tail | опашка
tangent | допирателна, допиращ/а се (до) | _[допирателна](https://en.wikipedia.org/wiki/Tangent) крива/права/равнина/пространство..._
