...
[emergent abilities](https://arxiv.org/pdf/2206.07682)/capabilities/[properties](https://study.com/academy/lesson/emergent-properties-definition-examples.html) | възникващи (съвкупно) възможности/поведение/свойства | _става дума за възможностите и особеностите, които проявяват големите модели на невронни мрежи (вкл. езикови), които (възможности) се проявяват само като резултат от съвкупната работа на невроните. тоест възникват като резултат от съвместното действие на невроните (слой по слой и накрая общо слоевете), които поединично не могат да извършат тези действия (като напр. синтез на текст, картина, звук; превод; определяне на класове и т.н)._
