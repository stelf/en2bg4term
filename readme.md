...
[blueprint](https://en.wikipedia.org/wiki/Blueprint) | чертеж, чернова, работен план | _може би сте виждали в по-стари филми изображения като [това например](https://airplanes3d.wordpress.com/wp-content/uploads/2019/08/0097-01.jpg), които са със синя основа и бели черти. не случайно bluetype обозначава точно този син отпечатък, при който се ползва синя химическа основа от [циян](https://en.wikipedia.org/wiki/Cyanotype) (където cyan всъщност е от гръцки κυάνεος, kyáneos и значи тъмно-син). в преносен смисъл това е чертеж, проект, дори образец за нещото преди да се появи то самото_
