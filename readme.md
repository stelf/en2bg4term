...
backdoor | задна врата | _понятие от областта на комп. сигурност. става дума за поставяне на софтуер, който предоставя скрит достъп до дадено приложене/система/сървър_ 
