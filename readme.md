## [Показалец](https://ibl.bas.bg/rbe/lang/bg/%D0%BF%D0%BE%D0%BA%D0%B0%D0%B7%D0%B0%D0%BB%D0%B5%D1%86/) (Индекс)
...
available | наличен
avatar | [лик](http://ibl.bas.bg/rbe/lang/bg/%D0%BB%D0%B8%D0%BA/), [облик](http://ibl.bas.bg/rbe/lang/bg/%D0%BE%D0%B1%D0%BB%D0%B8%D0%BA/), въплъщение, проявление | _avatar букв. означава "проявление на (хиндуистко) божество на земята във въплътен или осезаем вид", от санскрит avatarana "слизане" (на божество на земята във въплътена форма). обикновено се обозначава с това понятие представянето на облика на потребителя под формата на изображение (още - неговата 'икона')_. С други думи въплъщение, превъплъщение или проявление на човек или идея.
...
(backpropagation)[https://en.wikipedia.org/wiki/Backpropagation] | обратно предаване на грешката | понятие от областта на машинното самообучение
...
bucket | ведро, кофа, буре, барел(ч), каца (същ.) | _тук хора се търкалят от смях, но е факт, че bucket означава точно това и се ползва точно този смисъл. още по-веселото е, че кофа идва според [ВикиРечник](https://en.wiktionary.org/wiki/%D0%BA%D0%BE%D1%84%D0%B0) от Отомански Турски - ⁧قوغه⁩ (kova)_
...
bullet | водещ знак, точка (разг.) | това - • - макар че буквално означава куршум. на френски го превеждат la balle, което е „малко топче“ най-общо казано. може би също „кръгче“, а ние разговорно казваме „да караме по точките“ или нещо такова, което отразява видимото представяне на знака.
...
bus | шина (ч) | _от немско Schiene. [Wiki](https://bg.wikipedia.org/wiki/%D0%A8%D0%B8%D0%BD%D0%B0_(%D0%BA%D0%BE%D0%BC%D0%BF%D1%8E%D1%82%D1%80%D0%B8)_
...
EN  | BG  | Забележка
--- | --- | ---
daily, daily scrum, daily stand up | дневна среща/събрание, [спявка (жарг.)](https://ibl.bas.bg/rbe/lang/bg/%D1%81%D0%BF%D1%8F%D0%B2%D0%BA%D0%B0/) | _[описание на понятието](https://en.wikipedia.org/wiki/Stand-up_meeting). @toniuyt123 обръща внимание, че БАН са записали и руската дума _летучка_ като синоним на събрание/среща, но в ИТ литературата такова понятие на български няма да открием дори в най-старите университетски материали по математика и информатика, където се среща какво ли не. спорна е приложимостта на тази дума като превод и предвид фонетичната и близост до _лятоска_, която вероятно сме чували поне веднъж от прародителите си. предложението на спявка е предвид придобитото значение за "бърза среща", най-вече благодарение на писания в ежедневниците последнит години. вероятно и daily, daily scrum, daily stand up | дневна среща/събрание, [спявка](https://ibl.bas.bg/rbe/lang/bg/%D1%81%D0%BF%D1%8F%D0%B2%D0%BA%D0%B0/) | _[описание на понятието](https://en.wikipedia.org/wiki/Stand-up_meeting). @toniuyt123 обръща внимание, че БАН са записали и руската дума _летучка_ като синоним на събрание/среща, но в ИТ литературата такова понятие на български няма да открием дори в най-старите университетски материали по математика и информатика, където се среща какво ли не. спорна е приложимостта на тази дума като превод и предвид фонетичната и близост до _лятоска_, която вероятно сме чували поне веднъж от прародителите си. предложението на спявка е предвид придобитото значение за "бърза среща", най-вече благодарение на писания в ежедневниците последнит години. вероятно и седянка би била смислово подходяща, но не се наемаме..._ би била смислово подходяща, но не се наемаме..._
...
middleware | междинен слой, [промеждутък](http://ibl.bas.bg/rbe/lang/bg/%D0%BF%D1%80%D0%BE%D0%BC%D0%B5%D0%B6%D0%B4%D1%83%D1%82%D1%8A%D0%BA/) | _вторият превод е по-скоро пожелателен. всичко това бе обсъждано в #59_. с @kberov обсъждахме и [межда](https://ibl.bas.bg/rbe/lang/bg/%D0%BC%D0%B5%D0%B6%D0%B4%D0%B0/) впоследствие, което към този момент вероятно е най-точния превод. но думата е много стара и надали се знае изобщо.
minutes of meeting (МоМ) | [записка](https://ibl.bas.bg/rbe/lang/bg/%D0%B7%D0%B0%D0%BF%D0%B8%D1%81%D0%BA%D0%B0/), бележки от среща | _записка, твърди БАН е от руски, което е поради наставката -ка. запис, пиша и писмо очевидно са с общи [славянски корен](https://en.wiktionary.org/wiki/Reconstruction:Proto-Slavic/pis%D1%8Cmo)_
...
plaintext | обикновен текст | _при формати на данни и предаване чрез знаци_
